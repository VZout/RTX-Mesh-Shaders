...
BASE_FLAGS = [
        '-std=c++2a',
        '-IC:/Users/Viktor/Documents/Workspaces/RTX-Mesh-Shaders/external/fmt/include',
        '-IC:/Users/Viktor/Documents/Workspaces/RTX-Mesh-Shaders/external/glm/glm',
...
def MakeRelativePathsInFlagsAbsolute(flags, working_directory):
    ...
    path_flags = [ '-isystem', '-I', '-iquote', '--sysroot=', '-c' ]
    for flag in flags:
        new_flag = flag
